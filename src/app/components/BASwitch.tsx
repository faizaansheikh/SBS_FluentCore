...
export const BASwitch = (props: any) => {
    return(
       ...
       {!props.detail &&  <Label  className="d flex justify-center align-center" style={{  textWrap: 'nowrap', alignItems: 'center', width: '50%', color: tokens.colorBrandForeground2Pressed }}>
            {props.label}
